...
InventoryGUIInventoryToggleButton::InventoryGUIInventoryToggleButton(UIWidget *parent)
...
void InventoryGUIInventoryToggleButton::on_click()
{
...
void InventoryGUIInventoryToggleButton::set_shown_item(InventoryItem item)
{
   shown_item = item;
}
...
void InventoryGUIInventoryToggleButton::on_draw()
{
...
void InventoryGUIInventoryToggleButton::show(float speed)
{
...
void InventoryGUIInventoryToggleButton::hide(float speed)
{
