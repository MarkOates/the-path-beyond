...
bin/game$(EXE_EXTENSION): obj/inventory_item.o obj/game.o obj/logging.o
	g++ obj/inventory_item.o obj/logging.o obj/game.o -o bin/game $(OPENGL_LIB) -l$(ALLEGRO_FLARE_LIB) $(ALLEGRO_LIBS) -L$(ALLEGRO_FLARE_DIR)/lib -L$(ALLEGRO_DIR)/build/lib
...
obj/inventory_item.o: src/inventory_item.cpp include/logging.hpp
	g++ -o $@ -c -std=gnu++11 $< -I$(ALLEGRO_FLARE_DIR)/include -I$(ALLEGRO_DIR)/include -I./include
