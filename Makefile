...
obj/game.o: main.cpp include/style_assets.hpp include/logging.hpp start_screen.hpp include/script.hpp include/target_id.hpp world_render.hpp game/project.hpp game/script_helper.hpp game/load_game_scripts.hpp $(wildcard game/scripts/*)
